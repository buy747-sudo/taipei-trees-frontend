...
- **2026-06-11 RWD 分版決策**：首頁明確區分三種裝置。電腦版（>=1024px）採「左側大地圖 + 右側樹木列表/探索入口」工作台式布局，適合簡報與辦公室查詢；平板版（641–1023px）採大地圖堆疊資訊、探索卡片 2 欄，適合現場與會議展示；手機版（<=640px）隱藏資料數字列、保留搜尋/掃碼觸控優先，探索卡片 2 欄且極窄螢幕改 1 欄。
